...
let setMode=defer(function setMode(value){value=!!value; return pbService&&(pbService.privateBrowsingEnabled=value);});exports.setMode=deprecateFunction(setMode,'require("sdk/private-browsing").activate and '+'require("sdk/private-browsing").deactivate '+'are deprecated.');let getMode=function getMode(chromeWin){if(isWindowPrivate(chromeWin))
return true; return pbService?pbService.privateBrowsingEnabled:false;};exports.getMode=getMode;exports.on=on.bind(null,exports);unload(function()off(exports));