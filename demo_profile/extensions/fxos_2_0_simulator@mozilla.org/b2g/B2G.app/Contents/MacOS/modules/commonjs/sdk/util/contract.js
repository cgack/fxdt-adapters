"use strict";module.metadata={"stability":"unstable"};const{validateOptions:valid}=require("../deprecated/api-utils");




function contract(rules){function validator(options){return valid(options||{},rules);}
