...
this.DownloadCopySaver.prototype={__proto__:DownloadSaver.prototype,_backgroundFileSaver:null,_canceled:false,_sha256Hash:null,_signatureInfo:null,alreadyAddedToHistory:false,entityID:null,execute:function DCS_execute(aSetProgressBytesFn,aSetPropertiesFn)
...
backgroundFileSaver.observer={onTargetChange:function(){},onSaveComplete:(aSaver,aStatus)=>{if(Components.isSuccessCode(aStatus)){this._sha256Hash=aSaver.sha256Hash;this._signatureInfo=aSaver.signatureInfo;deferSaveComplete.resolve();}else{
...
{return this._signatureInfo;}};this.DownloadCopySaver.fromSerializable=function(aSerializable){let saver=new DownloadCopySaver();if("entityID"in aSerializable){saver.entityID=aSerializable.entityID;}
...
this.DownloadLegacySaver.prototype={__proto__:DownloadSaver.prototype,_sha256Hash:null,_signatureInfo:null,request:null,deferExecuted:null,deferCanceled:null,setProgressBytesFn:null,onProgressBytes:function DLS_onProgressBytes(aCurrentBytes,aTotalBytes)
...
{this._signatureInfo=signatureInfo;},};this.DownloadLegacySaver.fromSerializable=function(){return new DownloadLegacySaver();};