"use strict";module.metadata={"stability":"unstable"};const{Cc,Ci,Cr}=require("chrome");const{emit,on,off}=require("./core");const{addObserver}=Cc['@mozilla.org/observer-service;1'].getService(Ci.nsIObserverService);
...
addObserver(observerChannel,topic,true);return observerChannel;}
