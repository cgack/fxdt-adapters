...
addListItem(this,arguments[i]);},get length()listNS(this).keyValueMap.length,toString:function toString()'List('+listNS(this).keyValueMap+')',__iterator__:function __iterator__(onKeys,onKeyValue){let array=listNS(this).keyValueMap.slice(0),i=-1;for each(let element in array)
