'use strict';var util=require('./util');var l10n=require('./l10n');var spell=require('./spell');var filesystem=require('./filesystem');var Status=require('../types/types').Status;exports.parse=function(typed,options){return filesystem.stat(typed).then(function(stats){ if(options.existing==='no'&&stats.exists){return{value:undefined,status:Status.INCOMPLETE,message:l10n.lookupFormat('fileErrExists',[typed]),predictor:undefined
};}
