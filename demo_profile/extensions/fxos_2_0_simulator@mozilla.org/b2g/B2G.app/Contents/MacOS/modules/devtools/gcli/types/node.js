'use strict';var promise=require('../util/promise');var Highlighter=require('../util/host').Highlighter;var l10n=require('../util/l10n');var util=require('../util/util');var Status=require('./types').Status;var Conversion=require('./types').Conversion;var BlankArgument=require('./types').BlankArgument;var doc;if(typeof document!=='undefined'){doc=document;}
var emptyNodeList=[];exports.setDocument=function(document){doc=document;if(doc!=null){emptyNodeList=util.createEmptyNodeList(doc);}};exports.unsetDocument=function(){doc=undefined;emptyNodeList=undefined;};exports.getDocument=function(){return doc;};function onEnter(assignment){assignment.highlighter=new Highlighter(doc);assignment.highlighter.nodelist=assignment.conversion.matches;}
...
allowEmpty:false,constructor:function(){if(typeof this.allowEmpty!=='boolean'){throw new Error('Legal values for allowEmpty are [true|false]');}},getSpec:function(){return this.allowEmpty?{name:'nodelist',allowEmpty:true}:'nodelist';},getBlank:function(context){return new Conversion(emptyNodeList,new BlankArgument(),Status.VALID);},stringify:function(value,context){if(value==null){return'';}
