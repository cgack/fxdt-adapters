...
if(!hosts)
continue;hosts=hosts.split(",");for(let host of hosts){try{let uri=Services.io.newURI("http://"+host,null,null);Services.perms.add(uri,aPermission,aAction);}catch(e){}}
