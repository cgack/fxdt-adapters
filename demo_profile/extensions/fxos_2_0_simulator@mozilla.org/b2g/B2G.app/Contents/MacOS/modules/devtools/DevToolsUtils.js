"use strict";
var{Ci,Cu}=require("chrome");var Services=require("Services");var{setTimeout}=require("Timer");exports.safeErrorString=function safeErrorString(aError){try{let errorString=aError.toString();if(typeof errorString=="string"){
...
return undefined;};exports.hasSafeGetter=function hasSafeGetter(aDesc){let fn=aDesc.get;return fn&&fn.callable&&fn.class=="Function"&&fn.script===undefined;};exports.isSafeJSObject=function isSafeJSObject(aObj){if(Cu.getGlobalForObject(aObj)==Cu.getGlobalForObject(exports.isSafeJSObject)){return true;}
...
exports.dumpn.wantLogging=false;exports.dbg_assert=function dbg_assert(cond,e){if(!cond){return e;}}
