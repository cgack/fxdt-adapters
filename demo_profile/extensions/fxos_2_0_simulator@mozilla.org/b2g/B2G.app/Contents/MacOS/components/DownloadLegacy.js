...
this._deferDownload.promise.then(download=>{
if(Components.isSuccessCode(aStatus)){download.saver.setSha256Hash(this._sha256Hash);download.saver.setSignatureInfo(this._signatureInfo);}
...
{this._signatureInfo=signatureInfo;},_deferDownload:null,_cancelable:null,_componentFailed:false,_sha256Hash:null,_signatureInfo:null,};this.NSGetFactory=XPCOMUtils.generateNSGetFactory([DownloadLegacyTransfer]);