...
return;this._addToEnclosures(enc);},_mediaToEnclosures:function Entry_mediaToEnclosures(mediaType,contentType){var content=this.fields.getPropertyAsInterface(mediaType,Ci.nsIArray);if(contentType)
content=content.getPropertyAsInterface(contentType,Ci.nsIArray);for(var i=0;i<content.length;++i){var contentElement=content.queryElementAt(i,Ci.nsIWritablePropertyBag2);
